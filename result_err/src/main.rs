/* 
https://docs.microsoft.com/zh-cn/learn/modules/rust-error-handling/5-use-result-type
https://docs.microsoft.com/zh-cn/learn/modules/rust-error-handling/6-exercise-use-result-type

Rust 提供了用于返回和传播错误的 Result<T, E> 枚举。 
按照惯例，Ok(T) 变量表示成功并包含一个值，而变量 Err(E) 表示错误并包含一个错误值。
